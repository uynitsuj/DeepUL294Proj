...
def main():
    ...
    clip_trainloader = data.DataLoader(dataset["train"], batch_size, drop_last=True, num_workers=0,
                            collate_fn=clip_collate_fn)
    clip_testloader = data.DataLoader(dataset["validation"], batch_size, drop_last=True, num_workers=0,
                            collate_fn=clip_collate_fn)
